...
아들이 중학교에 올라가면서 예상한 일이 생겼다. 수학과 과학이 벽이 되기 시작한 것이다. 과외 선생님을 알아볼 수도 있었지만, 문득 다른 생각이 들었다.

*Claude가 있잖아.*

어차피 Naaru.code와 밤마다 코딩을 하고 있었다. 그 연장선에서 아들이 언제든 꺼내 쓸 수 있는 AI 학습 도우미를 만들어보기로 했다. 이름은 SeekerStone — Ultima 시리즈에서 진리를 탐구하는 돌이라는 의미다. 공부가 진리 탐구라면, 이름이 딱 맞다.
...
1. **퀴즈** — 과목/학년/시험 범위에 맞춰 AI가 문제를 낸다
...
자료 관리에 기능 하나를 욕심 냈다. 아이가 프린트물에 필기를 해뒀을 때, AI가 손글씨 영역을 감지하고 지워서 깔끔하게 정리해주는 기능이다.
...
만들고 나서 아들에게 보여줬더니, 첫 반응이 퀴즈보다 리포트 탭이었다. 자기 정답률이 숫자로 나오니까 신기했던 모양이다.

Ultima VI에서 가고일은 악당이 아니었다. 관점이 달랐을 뿐이다. AI가 공부를 대신해주는 게 아니라, 공부의 방향을 알려주는 도구가 되는 것 — 그게 SeekerStone이 있어야 할 자리다.
